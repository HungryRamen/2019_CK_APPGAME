...
/// 
[System.Serializable]
public class OldDialogStory : ScriptableObject 
{
    ...
    public OldDialogStoryData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new OldDialogStoryData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public OldDialogStoryData FindByKey(string key)
    //{
